                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <!--<div class="container">-->
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="image/seo-and-web.png" alt="user_icon">

                            <!--</div>--> 
                            <h1><%=m.get("userCount")%></h1>
                            <h1 class="text-uppercase text-muted"><a href="list.jsp"></a>
                                Users</h1>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <!--<div class="container">-->
                                <img style="max-width: 125px;" class="image-fluid rounded-circle" src="image/list.png" alt="user_icon">

                            <!--</div>--> 

                            <h1>3</h1>
                            <h1 class="text-uppercase text-muted">Vendors</h1>
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <!--<div class="container">-->
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="image/keys.png" alt="user_icon">
