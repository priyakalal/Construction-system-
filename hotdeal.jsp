...
<!--    <div class="d-block w-100">-->
                       ...
                       <a href="index.jsp?category=14" >
                               <img src="image/brand/s6.jpg"class="d-block w-100"  > </a>
                          
    </div>

<div class="col-2">
 <a href="index.jsp?category=16" >
    <img class="d-block w-100" src="image/brand/h3.png" alt="berger3"> </a>
 </div>
    
<div class="col-2">
    <a href="index.jsp?category=5" ><img class="d-block w-100" src="image/products/a78.jpg" alt="asian"> </a></div>
<div class="col-2"><a href="index.jsp?category=8" ><img class="d-block w-100" src="image/products/1.jpg" alt="apple ipad"></a></div>
<div class="col-2"><a href="index.jsp?category=10" ><img class="d-block w-100" src="image/products/gl1.jpg" alt="apple ipad"></a></div>
<div class="col-2"><a href="index.jsp?category=5" ><img class="d-block w-100" src="image/products/a5.jpg" alt="applewatch"></a></div>
</div>
    </div>
<!--/end of slider 1-->
